...
export const sitters: SitterProfile[] = [
  {
    ...
    bestWithAgeMin: 0,
    bestWithAgeMax: 5,
    offersSchoolPickup: false,
    offersEveningCare: true,
    availability: [],
  },
  {
    id: "sit_2",
    ...
    bestWithAgeMin: 5,
    bestWithAgeMax: 12,
    offersSchoolPickup: true,
    offersEveningCare: false,
    availability: [],
  },
  {
    id: "sit_3",
    ...
    name: "Jordan P.",
    suburb: "Bundeena",
    bio: "New to the area — application submitted, waiting on approval.",
...
export const messages: Message[] = [
  {
    ...
    bookingId: "bkg_1",
    senderName: "Sam K.",
    body: "Hi Chloe! Excited to have you watch the kids Saturday.",
